<div class="merge-sort-wrapper">
    ...
    <div class="controls-wrap">
        <div class="controls">
            <button class="btn btn-light" id="m-sort-step">
                <span class="bi bi-skip-forward-fill"></span>
            </button>
            <button class="btn btn-light" id="m-sort-play">
                <span class="bi bi-play-fill"></span>
            </button>
            <button class="btn btn-light" id="m-sort-pause">
                <span class="bi bi-pause-fill"></span>
            </button>
            <button class="btn btn-light" id="m-sort-reset">
